 ...
 * ui.types.ts
 * 
 * Central definitions for UI-related types used throughout the application.
 * These types define the user interface state, components, and interactions.
 */
...
export interface WorkflowState {
  ...
  stepHistory?: ApplicationStep[] | string[];
