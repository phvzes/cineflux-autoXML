...
const VideoProcessingTest: React.FC = () => {
  ...
  const processVideo = useCallback(async () => {
    ...
    try {
      ...
      const errorMessage = `Failed to process video: ${error instanceof Error ? error.message : String(error)}`;
  ...
  }, [videoFile, showNotification, retryCount]);
  ...
  const handlePlayPauseToggle = () => {
    ...
    if (isPlaying) {
      ...
      videoRef.current.play().catch(error => {
        ...
        showNotification('error', `Playback failed: ${error.message}`);
      });
    }
  ...
  return (
    <div className="video-processing-test p-6 bg-[#1A1A1F] min-h-screen">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-[#F5F5F7] mb-6">Video Processing Test</h1>
        
        <p className="mb-6 text-[#B0B0B5]">
        ...
        {!videoFile && (
          ...
          >
            ...
            <p className="text-lg mb-2 text-[#F5F5F7]">Drag & drop a video file here, or click to select</p>
        ...
        {videoFile && videoUrlRef.current && (
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold text-[#F5F5F7]">Video Preview</h2>
            ...
            <div className="bg-[#1E1E24] p-4 rounded-lg">
              ...
              <div className="mt-4">
                <p className="font-medium text-[#F5F5F7]">{videoFile.name}</p>
                <p className="text-sm text-[#B0B0B5]">
        ...
        {/* Processing progress */}
        {videoFile && (isProcessing || error || isComplete) && (
          <div className="mb-6">
            <h2 className="text-xl font-semibold mb-4 text-[#F5F5F7]">Video Analysis</h2>
            
            <div className="bg-[#2A2A30] p-6 rounded-lg">
              <ProcessingProgress
        ...
        {processingResult && videoFile && (
          <div className="mb-6">
            <h2 className="text-xl font-semibold mb-4 text-[#F5F5F7]">Video Analysis Results</h2>
        ...
        <div className="mt-12">
          <h2 className="text-xl font-semibold mb-4 text-[#F5F5F7]">How It Works</h2>
          
          <div className="bg-[#1E1E24] p-6 rounded-lg">
            <p className="mb-4 text-[#B0B0B5]">
            ...
            <h3 className="text-lg font-medium mb-2 text-[#F5F5F7]">Processing Steps:</h3>
            <ol className="list-decimal list-inside space-y-2 mb-6 text-[#B0B0B5]">
            ...
            <h3 className="text-lg font-medium mb-2 text-[#F5F5F7]">Features:</h3>
            <ul className="list-disc list-inside space-y-2 text-[#B0B0B5]">
